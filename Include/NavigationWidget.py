...
class NavigationToolBar(QToolBar):
    ...
    def initLayout(self):
        ...
        self.addWidget(self.btncheck)
        self.editUrl.setFixedHeight(30)
    ...
    def initControl(self):
        ...
        self.btncheck.clicked.connect(self.CheckWeb)
        self.btncheck.setIcon(QIcon('./Resource/check.png'))
        self.btncheck.setToolTip('Check')
